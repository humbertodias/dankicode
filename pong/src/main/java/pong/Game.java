...
public class Game implements Runnable, KeyListener {
  ...
  private void drawGameOverFrame(Graphics g) {
    ...
    if (this.fase == 0) {
      ...
      this.ball.drawPongPlayer(g);
      g.drawString(
          "Pong Player", (this.ball.SCREEN_WIDTH / 2) - 30, (this.SCALE * this.HEIGHT) / 2 - 50);
      ...
      g.drawString(
          "YOU WIN!", (this.ball.SCREEN_WIDTH / 2) - 30, (this.SCALE * this.HEIGHT) / 2 - 10);
      ...
      g.drawString(
          "GAME OVER", (this.ball.SCREEN_WIDTH / 2) - 30, (this.SCALE * this.HEIGHT) / 2 - 10);
      g.drawString("Press UP key to start a new game", 20, (this.SCALE * this.HEIGHT) / 2 + 30);
    }
