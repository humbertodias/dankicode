...
public class Enemy extends Entity {
  ...
  public Enemy(int x, int y, int width, int height, BufferedImage sprite) {
    ...
    enemySprites[0] =
        Game.spritesheet.getSprite(
            World.TILE_SIZE * 8, World.TILE_SIZE * 0, World.TILE_SIZE, World.TILE_SIZE);
    enemySprites[1] =
        Game.spritesheet.getSprite(
            World.TILE_SIZE * 9, World.TILE_SIZE * 0, World.TILE_SIZE, World.TILE_SIZE);

    enemySpritesDamaged[0] =
        Game.spritesheet.getSprite(
            World.TILE_SIZE * 8, World.TILE_SIZE * 1, World.TILE_SIZE, World.TILE_SIZE);
    enemySpritesDamaged[1] =
        Game.spritesheet.getSprite(
            World.TILE_SIZE * 9, World.TILE_SIZE * 1, World.TILE_SIZE, World.TILE_SIZE);
  }
  ...
  public boolean isCollidingWithPlayer() {
    Rectangle enemyCurrent =
        new Rectangle(this.getX(), this.getY(), World.TILE_SIZE, World.TILE_SIZE);
    Rectangle player =
        new Rectangle(Game.player.getX(), Game.player.getY(), World.TILE_SIZE, World.TILE_SIZE);
