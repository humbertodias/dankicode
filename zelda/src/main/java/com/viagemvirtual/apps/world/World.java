/**
 * Aulas: - Módulo #10: Criando game engine e jogo #1(Zelda Clone) > Iniciando com mapa - Módulo
 * #10: Criando game engine e jogo #1(Zelda Clone) > Tiles e validando posições - Módulo #10:
 * Criando game engine e jogo #1(Zelda Clone) > Entities no mapa yeelws 22.06.2019 20:38
 *
 * <p>Class World - package "world" Trata dos mapas do jogo Foi ensinado a fazer o mapa na aula
 * "Finalizando Sprites" a partir dos 00:07:00 minutos Tamanho do primeiro mapa: 20px x 20px - Todo
 * pixel preto 0xFF000000 é chão; - Todo pixel branco 0xFFFFFFFF é parede; - Azul 0xFF0000ff é o
 * jogador no centro do mapa - Vermelho 0xFFFF0000 é o inimigo - Item de vida 0xFF00FF00 Verde -
 * Munição: Amarelo 0xFFFFFF00 - Arma: Laranja OxFFFF5100
 */
