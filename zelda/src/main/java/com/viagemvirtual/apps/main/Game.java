/**
 * Zelda - Clone yeelws nodmance virilaeo - 21.06.2019 Curso Desenvolvimento de Games Completo
...
public class Game extends Canvas implements Runnable, KeyListener, MouseListener {
  ...
  public void render() {
    ...
    if (gameState == "GAME_OVER") {
      ...
      g2D.drawString(
          "GAME OVER",
          ((WIDTH * SCALE) / 2) - Camera.x - 20,
          ((HEIGHT * SCALE) / 2) - Camera.y + 20);
      g2D.setFont(new Font("Arial", Font.BOLD, 30));
      g2D.setColor(Color.WHITE);
      g2D.drawString(
          "Press >ENTER< to Restart",
          ((WIDTH * SCALE) / 2) - Camera.x - 80,
          ((HEIGHT * SCALE) / 2) - Camera.y + 80);
    }
